...
const AuthenticationLogin = () => {
  ...
  const [loginMethod, setLoginMethod] = useState<"username">("username");
  const [username, setUsername] = useState("");
  const [password, setPassword] = useState("");
  const [errorMessage, setErrorMessage] = useState<string | null>(null);

  const [emailLogin, { isLoading: isLoggingIn }] = useLoginMutation();
  ...
  const handleLogin = async () => {
    ...
    try {
      // Pass the username as 'employee_id' parameter
      const result = await emailLogin({ employee_id: username, password }).unwrap();
      ...
      setErrorMessage(error?.data?.detail || "Login failed");
    }
  };
            ...
            <div className="w-full max-w-[440px] lg:mt-16">
              <div className="mb-10">
                ...
                <Subtitle isDark={isDark}>
                  Please provide your Employee ID and password to access your account.
                </Subtitle>
              </div>
              ...
              <InputWrapper>
                <InputLabel isDark={isDark}>Employee ID</InputLabel>
                <EmailInput
                  type="text"
                  value={username}
                  isDark={isDark}
              ...
              <SubmitButton onClick={handleLogin} disabled={isLoggingIn}>
                <span>
