...
const DateRangePicker: React.FC<DateRangePickerProps> = ({
  ...
  return (
    <div className="relative" ref={pickerRef}>
      ...
      >
        <CalendarMonthOutlined
          className={`w-5 h-5 ${isOpen ? "text-blue-600" : "text-gray-600"}`}
        />
      ...
      {isOpen && (
        <div className="absolute z-50 mt-2 bg-white rounded shadow-2xl border border-gray-200 p-2 w-[750px] right-0">
